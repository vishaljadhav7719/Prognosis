...
function setMailWelcomeRecruiter(password)
{
  return `
    <div style="width:100%;text-align:center;">
      <div style="font-size:23px;font-weight:900;font-family:monospace;padding:20px 10px;letter-spacing:1px;">Placement Prediction System</div>
      ...
      <div>
        ...
        <div style="display:flex;font-size:16px;font-weight:900;font-family:monospace;letter-spacing:1px;color:#000">
          <div style="padding:10px 8px;margin:0px auto;">Vishal</div>
          <div style="padding:10px 8px;margin:0px auto;">Ekansh</div>
          <div style="padding:10px 8px;margin:0px auto;">Sanyami</div>
          <div style="padding:10px 8px;margin:0px auto;">Shubham</div>
        </div>
      </div>
      <div style="color:#000;padding:10px 0px;text-align:center;font-family:monospace;font-size:20px;letter-spacing:1px;background:linear-gradient(135deg,#64B5F6,#0D47A1)">Have a nice day !!!</div>
    </div>
  `;
}
