...
var output,prediction,correct=0,i=0;
raw_data.forEach(d=>{
  output=NeuralNetwork([d["engineering"],d["sslc"],d["plustwo"],d["ug"],d["pg"],d["project"],d["intern"],d["extras"],d["arrears"]]);
...
console.log("\n\nTotal Records\t\t:\t"+i);
console.log("Correct Prediction\t:\t"+correct);
console.log("Incorrect Prediction\t:\t"+(i-correct));
console.log("Prediction accuracy\t\:\t"+((correct*100)/i));
// function test(inp)
// {
